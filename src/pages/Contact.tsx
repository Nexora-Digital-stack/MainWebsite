...
const Contact = () => {
  ...
  const contactInfo = [
    {
      icon: Mail,
      title: 'Email Us',
      details: 'digitalnexora5@gmail.com',
    },
    {
      icon: Phone,
      title: 'Call Us',
      details: '+91 8287912271',
    },
    {
      icon: MapPin,
      title: 'Visit Us',
  ...
  return (
    <Layout
      ...
      description="Get in touch with Nexora Digital for expert digital marketing services. Free consultation available. Call +91 8287912271 or email digitalnexora5@gmail.com"
